 ...
 * Generic type for custom `DTAFile` types.
 */
export type PartialDTAFileExpanded<T> = PartialDTAFile & T
...
export interface PartialDTAFileWithIndex extends PartialDTAFile {
  /**
   * The index of the song on the array.
   */
  index: number
...
export type DTAWithIndexReturnType<T extends DTAFile[] | PartialDTAFile[]> = T extends DTAFile[] ? DTAFileWithIndex[] : PartialDTAFileWithIndex[]
/**
 * A `Map` class with `DTAFile` keys and values.
 */
export type DTAMap = Map<keyof DTAFile, DTAFile[keyof DTAFile]>
export type DTARecord = Record<keyof DTAFile, DTAFile[keyof DTAFile]>
export type PartialDTARecord = Record<keyof DTAFile, PartialDTAFile[keyof DTAFile]>
