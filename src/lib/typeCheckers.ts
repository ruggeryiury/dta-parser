...
export const isDTAFile = (song: DTASongObjectTypes): song is DTAFile => {
  return typeof song === 'object' && 'name' in song && 'artist' in song && 'id' in song && 'tracks_count' in song && 'pans' in song && 'vols' in song && 'vocal_parts' in song && 'bank' in song && 'drum_bank' in song && 'anim_tempo' in song && 'rank_band' in song && 'game_origin' in song && 'rating' in song && 'genre' in song && 'vocal_gender' in song && 'year_released' in song && 'album_art' in song
}
