...
export type SongSubGenreTypes = keyof typeof allSubGenres

export const subGenreLocale = (sub_genre: SongSubGenreTypes): string => {
    return allSubGenres[sub_genre] ? allSubGenres[sub_genre] : sub_genre
}
